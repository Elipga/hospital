...
public class DoctorInput {
    ...
    public static HealthStaff getStaff(DoctorInput doctorInput) throws InvalidException {
        return new HealthStaff(doctorInput.getId(), doctorInput.getCollegeNumber(), doctorInput.getName(),
                doctorInput.getStartingTime(), doctorInput.endingTime);
    }
}
